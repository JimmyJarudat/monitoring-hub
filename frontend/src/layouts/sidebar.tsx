...
const IconCredentials = () => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="h-5 w-5">
    <path strokeLinecap="round" strokeLinejoin="round" d="M15.75 5.25a3 3 0 0 1 3 3m3 0a6 6 0 0 1-7.029 5.912c-.563-.097-1.159.026-1.563.43L10.5 17.25H8.25v2.25H6v2.25H2.25v-2.818c0-.597.237-1.169.659-1.591l6.499-6.499c.404-.404.527-1 .43-1.563A6 6 0 0 1 21.75 8.25Z" />
  </svg>
);
...
const IconSystemLogs = () => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="h-5 w-5">
    <path strokeLinecap="round" strokeLinejoin="round" d="m6.75 7.5 3 2.25-3 2.25m4.5 0h3m-9 8.25h13.5A2.25 2.25 0 0 0 21 18V6a2.25 2.25 0 0 0-2.25-2.25H5.25A2.25 2.25 0 0 0 3 6v12a2.25 2.25 0 0 0 2.25 2.25Z" />
  </svg>
);

const IconScheduledReports = () => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="h-5 w-5">
...
const IconMaintenance = () => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="h-5 w-5">
    <path strokeLinecap="round" strokeLinejoin="round" d="M6.75 3v2.25M17.25 3v2.25M3.75 7.5h16.5m-13.5 5.25h2.25m-2.25 3h2.25m3-3h2.25m-2.25 3h2.25m3-3h2.25m-2.25 3h2.25M5.25 21h13.5A2.25 2.25 0 0 0 21 18.75V6.75a2.25 2.25 0 0 0-2.25-2.25H5.25A2.25 2.25 0 0 0 3 6.75v12A2.25 2.25 0 0 0 5.25 21Z" />
  </svg>
);
...
const Sidebar = () => {
  ...
  const sidebarSections: SidebarSection[] = [
    ...
    },
    {
      ...
      items: [
        ...
        { label: t("sidebar.maintenance"), path: "/maintenance-windows", icon: <IconMaintenance /> },
      ],
    },
    {
      title: t("sidebar.dbInsight"),
      items: [
        { label: t("sidebar.dbInsightOverview"), path: "/db-insight", icon: <IconDbInsight /> },
      ],
    },
    {
  ...
  return (
    <aside className="flex h-screen w-72 flex-col border-r border-slate-800 bg-slate-950 text-white dark:border-slate-700 dark:bg-slate-800">
      <div className="flex h-20 items-center gap-3 border-b border-slate-800 px-5 dark:border-slate-700">
                    ...
                    className={({ isActive }) =>
                      [
                        ...
                        isActive
                          ...
                          : "text-slate-300 hover:bg-slate-900 hover:text-white dark:hover:bg-slate-700",
                      ].join(" ")
                    }
                    end={item.end}
                    key={item.path}
                      ...
                      <>
                        <span
                          className={[
                            ...
                            isActive
                              ? "bg-slate-950 text-cyan-300 dark:bg-slate-900"
                              : "bg-slate-900 text-slate-400 group-hover:bg-slate-800 group-hover:text-cyan-300 dark:bg-slate-700 dark:group-hover:bg-slate-600",
                          ].join(" ")}
                        >
                          {item.icon}
                        </span>
      ...
      <div className="border-t border-slate-800 px-4 py-3 dark:border-slate-700">
        <div className="rounded-xl border border-slate-700/60 bg-linear-to-b from-slate-800/60 to-slate-900/80 px-3.5 py-3 shadow-inner dark:border-slate-600/60 dark:from-slate-700/60 dark:to-slate-700/80">
