...
const DNS_BRUTEFORCE_CONCURRENCY = getNumberEnv("DOMAIN_DISCOVERY_DNS_CONCURRENCY", 12, 1, 50);
const PLUGIN_TIMEOUT_MS = getNumberEnv("DOMAIN_DISCOVERY_DNS_PLUGIN_TIMEOUT_MS", 60000, 5000, 180000);
const RESOLVE_TIMEOUT_MS = getNumberEnv("DOMAIN_DISCOVERY_DNS_TIMEOUT_MS", 2000, 500, 10000);
